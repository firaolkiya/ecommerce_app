...
// in ecommerce/test/mock_data.dart.
...
import 'package:ecommerce/domain/repositories/wishlist_repository.dart' as _i7;
...
class MockWishlistRepository extends _i1.Mock
    implements _i7.WishlistRepository {
  MockWishlistRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<_i5.ProductEntity>> getWishlist() => (super.noSuchMethod(
        Invocation.method(
          #getWishlist,
          [],
        ),
